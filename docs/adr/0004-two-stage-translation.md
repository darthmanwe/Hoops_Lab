...
reversion, minutes — on 7,902 consecutive _same-league_ pairs.
...
Aging is therefore estimated at n = 7,902. Only the league term depends on the
small sample.
...
- Selection is treated three ways rather than apologised for: shown (the gap is
  ...
  and without).
- The direction-specific slopes **disagree** — 0.580 for EL→NBA against 0.986
